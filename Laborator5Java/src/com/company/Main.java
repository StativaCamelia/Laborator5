...
public class Main {
    ...
    private void testCreateSave(){
        Catalog catalog =
                new Catalog("Java Resources", "D:/Laborator5/Laborator5Java/catalog.ser");
    ...
    private void testCreateSaveJson(){
        Catalog catalog = new Catalog("Java Resources", "D:/Laborator5/Laborator5Java/catalog.json");
    ...
    public void testLoadJson(){
        ...
        try {
            catalog = CatalogUtil.loadPlainText("D:/Laborator5/Laborator5Java/catalog.json");
        }
    ...
    private void testLoadView(){
        Catalog catalog = new Catalog();
        try {
            catalog = CatalogUtil.load("D:/Laborator5/Laborator5Java/catalog.ser");
        }
